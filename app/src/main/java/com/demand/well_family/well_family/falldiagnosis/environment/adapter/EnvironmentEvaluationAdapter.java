package com.demand.well_family.well_family.falldiagnosis.environment.adapter;
...
public class EnvironmentEvaluationAdapter extends RecyclerView.Adapter<EnvironmentEvaluationAdapter.DangerEvaluationViewHolder> {
    ...
    public EnvironmentEvaluationAdapter(ArrayList<Evaluation> dangerEvaluationList, Context context) {
