                                            ...
                                            call_write_photo.enqueue(new Callback<ResponseBody>() {
                                                ...
                                                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                    if (response.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(CreateStoryActivity.this, new ErrorUtil(getClass()).parseError(response).message(), Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                                ...
                                                public void onFailure(Call<ResponseBody> call, Throwable t) {
                                                    log(t);
                                                    Toast.makeText(CreateStoryActivity.this, "네트워크 불안정합니다. 다시 시도하세요.", Toast.LENGTH_LONG).show();
                                                }
                                            });
        ...
        btn_write_photo_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photoList.size() >= 10) {
                    Toast.makeText(CreateStoryActivity.this, "사진은 최대 10개까지 등록이 가능합니다.", Toast.LENGTH_SHORT).show();
                } else {
                    intent = new Intent();
        ...
        public PhotoViewHolder(View itemView) {
            ...
            iv_write_upload_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(CreateStoryActivity.this, "사진이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
