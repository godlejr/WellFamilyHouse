package com.demand.well_family.well_family.dialog.list.songstory;
...
public class SongStoryDialogActivity extends Activity {
    // user_info
    ...
    private static final Logger logger = LoggerFactory.getLogger(SongStoryDialogActivity.class);
