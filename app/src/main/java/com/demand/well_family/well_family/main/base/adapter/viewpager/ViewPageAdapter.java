...
public class ViewPageAdapter extends PagerAdapter {
    ...
    public ViewPageAdapter(LayoutInflater inflater,Context context) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (position == 0) {
            Glide.with(context).load(context.getString(R.string.cloud_front_banners) + "demand_banner1.jpg").thumbnail(0.5f).crossFade().diskCacheStrategy(DiskCacheStrategy.ALL).into(img);
        } else if (position == 1) {
