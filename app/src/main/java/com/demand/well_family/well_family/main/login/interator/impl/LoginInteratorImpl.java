package com.demand.well_family.well_family.main.login.interator.impl;
...
public class LoginInteratorImpl implements LoginInterater {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LoginInteratorImpl.class);

    private MainServerConnection mainServerConnection;
    private UserServerConnection userServerConnection;


    public LoginInteratorImpl(LoginPresenter loginPresenter) {
