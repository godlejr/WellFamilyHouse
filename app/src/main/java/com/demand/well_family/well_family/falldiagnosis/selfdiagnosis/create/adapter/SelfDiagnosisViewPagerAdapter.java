package com.demand.well_family.well_family.falldiagnosis.selfdiagnosis.create.adapter;
...
public class SelfDiagnosisViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final FallDiagnosisContentCategory category = fallDiagnosisContentCategoryList.get(position);
        ...
        btn_falldiagnosis_answer_no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                selfDiagnosisPresenter.onClickAnswer(position, categorySize, category.getId(), SelfDiagnosisCodeFlag.NO);
            }
        });
        btn_falldiagnosis_answer_ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selfDiagnosisPresenter.onClickAnswer(position, categorySize,category.getId(),SelfDiagnosisCodeFlag.YES);
            }
        });
