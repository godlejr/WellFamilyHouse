package com.demand.well_family.well_family.falldiagnosisstory.detail.presenter.impl;
...
import com.demand.well_family.well_family.falldiagnosisstory.detail.interactor.FallDiagnosisStoryDetailInteractor;
import com.demand.well_family.well_family.falldiagnosisstory.detail.interactor.impl.FallDiagnosisStoryDetailInteractorImpl;
...
public class FallDiagnosisStoryDetailPresenterImpl implements FallDiagnosisStoryDetailPresenter {
    ...
    public void onLoadData() {
        ...
        if (isLikeChecked != null) {
            ...
            fallDiagnosisStoryDetailInteractor.getContentLikeCheck(fallDiagnosisStory);
        }
    ...
    public void setFalldiagnosisStoryComment(CommentInfo commentInfo) {
        ...
        if (commentLength > 0) {
            ...
            fallDiagnosisStoryDetailView.showMessage("댓글을 입력해주세요");
        }
    }
    ...
    public void onClickMenuButton() {
        FallDiagnosisStoryInfo fallDiagnosisStoryInfo = fallDiagnosisStoryDetailInteractor.getFallDiagnosisStoryInfo();
        FallDiagnosisStory fallDiagnosisStory = fallDiagnosisStoryDetailInteractor.getFallDiagnosisStory();
        fallDiagnosisStoryDetailView.navigateToFallDiagnosisStoryDialogActivity(fallDiagnosisStory, fallDiagnosisStoryInfo);
    }
