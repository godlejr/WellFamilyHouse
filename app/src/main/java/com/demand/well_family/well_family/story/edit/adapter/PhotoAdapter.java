...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public PhotoAdapter(ArrayList<Uri> photoList, Context context, int layout, EditStoryPresenter editStoryPresenter) {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case  R.id.iv_write_upload_delete:
                    ...
                    editStoryPresenter.onClickPhotoDelete(position, EditStoryCodeFlag.PHOTO_FLAG);
                    break;
            }
        }
    }
