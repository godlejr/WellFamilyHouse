package com.demand.well_family.well_family.falldiagnosis.selfdiagnosis.result.activity;
...
import com.demand.well_family.well_family.falldiagnosis.selfdiagnosis.result.presenter.impl.SelfDiagnosisResultPresenterImpl;
...
public class SelfDiagnosisResultActivity extends Activity implements SelfDiagnosisResultView, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int fallDiagnosisContentCategorySize = getIntent().getIntExtra("fallDiagnosisContentCategorySize", 0);
        selfDiagnosisResultPresenter = new SelfDiagnosisResultPresenterImpl(this);
        selfDiagnosisResultPresenter.onCreate(answerList, fallDiagnosisCategory, fallDiagnosisContentCategorySize);
    }
    ...
    public void init() {
        ...
        tv_score = (TextView) findViewById(R.id.tv_environmentevaluation_score);
