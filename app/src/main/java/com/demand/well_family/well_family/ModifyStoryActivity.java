                                                ...
                                                call_write_photo.enqueue(new Callback<ResponseBody>() {
                                                    ...
                                                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                        if (response.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(ModifyStoryActivity.this, new ErrorUtils(getClass()).parseError(response).message(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
    ...
    public void setToolbar(View view, Context context, String title) {
        ...
        ll_menu_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ModifyStoryActivity.this, UserActivity.class);
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.menu_home:
                        intent = new Intent(ModifyStoryActivity.this, MainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        break;

                    case R.id.menu_market:
                        intent = new Intent(ModifyStoryActivity.this, MarketMainActivity.class);
                        startActivity(intent);
                    ...
                    case R.id.menu_logout:
                        ...
                        intent = new Intent(ModifyStoryActivity.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                        break;
