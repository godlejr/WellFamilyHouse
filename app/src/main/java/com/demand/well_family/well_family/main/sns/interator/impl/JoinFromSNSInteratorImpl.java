...
public class JoinFromSNSInteratorImpl implements JoinFromSNSInterator {
    private JoinFromSNSPresenter joinFromSNSPresenter;

    private static final Logger logger = LoggerFactory.getLogger(JoinFromSNSInteratorImpl.class);
    private MainServerConnection mainServerConnection;
    private UserServerConnection userServerConnection;


    public JoinFromSNSInteratorImpl(JoinFromSNSPresenter joinFromSNSPresenter) {
